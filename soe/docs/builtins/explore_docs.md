...
| `docs/guide_01_tool.md` | File content or sections within |
| `docs/guide_01_tool.md/Your First Tool Node` | Specific section content |
| `docs/advanced_patterns/` | Directory contents |
